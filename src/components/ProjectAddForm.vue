  ...
  <div class="project-add-form w-75 mb-4">
    <form @submit.prevent="submitForm">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-10">
          <input id="proyecto" v-model="form.proyecto" type="text" class="form-control" placeholder="Recaudaciones" required />
        </div>
      </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-10">
          <div class="row">
            <div class="col">
              <input id="inicio" v-model="form.vigencia.inicio" type="date" class="form-control" placeholder="Desde" required />
            </div>
            <div class="col">
